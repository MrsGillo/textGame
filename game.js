        ...
        scenes = [
            ...
            },
            {
                ...
                options: [
                    ...
                    {
                        optionText: "Du betrittst den Laden. Hinter der Theke steht ein alter, schlecht gelaunter Zwerg. Seine Laune ändert sich jedoch rasch, als du ihm den Diamanten zeigst. Er bietet dir sein bestes Ritterschwert im Tausch gegen den Diamanten an und du nimmst das Schwert dankend an dich.",
            ...
            },
            {
                ...
                options: [
                    ...
                    {
                        optionText: "Der Diamant in deinem Beutel leuchtet und pulsiert so stark, dass du selbst durch den Stoff des Beutels darauf aufmerksam wirst. Keine Sekunde zu früh ziehst du reflexartig den Diamanten aus dem Beutel und reflektierst den Zauber auf den Drachen.",
                        showThisOption: () => inventory.diamond,
                        nextScene: 10
                    }
                ]
            ...
            {
                id: 6,
                sceneDescription: "Als du das Eingangstor betrittst, landet der gewaltige Drache vor dir. Du fühlst die Wucht, als er auf dem Boden aufsetzt, für einen Bruchteil vibrieren und die Steine zittern um dich herum. Der Drache ist in der Angriffshaltung und wird jeden Moment auf dich zu stürmen.",
            ...
            {
                id: 10,
                sceneDescription: "Du hast die Schwachstelle des Drachens perfekt ausgenutzt und dieser fällt zu Boden, noch bevor er dir etwas antun konnte. Ohne den Drachen, der über das Schloss wacht, erkundest du nun das Grundstück. An der Spitze des Schlossturms entdeckst du eine Person. Du befreist die Person, ihr verliebt euch und lebt glücklich bis ans Ende eures Lebens.",
